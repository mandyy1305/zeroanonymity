   ...
   <div className="bg-red-400 h-full flex">
        ...
        <div className="bg-sky-100 w-1 invisible lg:visible lg:w-3/4">
            <div className="bg-[#299595] h-[45px] flex items-center pl-4 border-t-[2px] border-b-[2px] border-black">
                <img src="https://banner2.cleanpng.com/20180523/tha/kisspng-businessperson-computer-icons-avatar-clip-art-lattice-5b0508dc6a3a10.0013931115270566044351.jpg" alt="I" className="rounded-full h-8 w-8"/>
                <span className="ml-4 text-lg font-semibold text-white">Someone</span>
            </div>
            <div className="bg-sky-100 h-5/6 flex flex-col">
                <div className="m-3 rounded-xl bg-white h-5/6 border-[1px] border-black p-2 flex flex-col justify-end
                    overflow-y-auto">
                ...
                <div className="bg-sky-100 h-1/6 pl-3 flex ">
                    <input type="text" className="w-11/12 h-[35px] rounded-lg p-4 text-sm border-[1px] border-black" placeholder="Message"/>
