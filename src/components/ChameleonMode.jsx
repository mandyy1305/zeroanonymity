import { setUser_2, user_2 } from "../../backend/src/GlobalValues";
...
const ChameleonMode = ({setCurrentUserFunc}) => {
    ...
    return(
          <button className="mr-20 h-10 flex justify-center mb-2 items-center px-2 rounded-xl border-[2px] border-blue-600" onClick={handleClick}>
