...
const SearchUsername = () => {
  return (
    <div className=" flex flex-col py-10 px-4 border-[1px] border-gray-500 rounded-2xl mx-1 mt-1">
          <p className=" text-lg text-white font-semibold ml-8">Start a new chat :</p>
          ...
          <button className="bg-[#00000000] border-[2px] border-[#006EA6] text-[#006EA6] w-1/3 h-12 rounded-lg mx-auto">Begin Chat</button>
    </div>
  );
};
